...
public:
	...
	using FunctionPtr = TBaseStaticDelegateInstance<FGameplayAttribute(), FDefaultDelegateUserPolicy>::FFuncPtr;
	...
	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_Viger, Category = "Vital Attributes")
