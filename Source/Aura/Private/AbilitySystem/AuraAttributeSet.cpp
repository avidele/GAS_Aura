...
UAuraAttributeSet::UAuraAttributeSet()
{
	...
	// TagsToAttributes.Add(GameplayTags.Attribute_Primary_Strength, StrengthSignature);
...
void UAuraAttributeSet::OnRep_Viger(const FGameplayAttributeData& OldVigor) const
{
